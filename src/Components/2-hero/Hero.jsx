...
const Hero = () => {
  return (
    <section className='hero d-flex align-items-center'>
      ...
      <div className='right-side-hero flex-grow-1'>
        <h1 className='title'>
          Nader Mamdouh  
          <svg
            width="36"
        ...
        <p className='sub-title'>
          I am a Software Developer with a bachelor’s degree in computer and Artificial Intelligence from Helwan University. Skilled in Web Technologies with a proven track record in developing robust applications, including E-commerce platforms, management systems and Digital Library for Helwan University. Passionate about web development, eager to take on new challenges, and committed to clean code and innovative solutions.
        </p>
        <div className=" d-flex justify-content-between align-items-center">
          <div className="all-icons">
            <div className="icons-cont icon-linkedin-square"></div>
            <div className="icons-cont icon-github"></div>
